...
class Test:
    def __init__(self,driver):
        ...
        self.const = const
        self.screen_count = []
        self.check_list = ["openDictionary","showPurchase","openDailyPuzzle",'loginToFb','showProfile']
        self.screen_coun = []
    ...
    def select_the_active(self):
        ...
        """
        if self.game.current_screen == "puz_pack" or self.game.current_screen == "country":
            self.game.tap_sprite("#white_arrow.png")
        elif self.game.current_screen == "linear_progression":
            self.game.tap_sprite("#cur_level_img.png")
    ...
    def start(self):
        ...
        while(len(temp_stack)):
            if self.game.current_screen == "puzzle" and count >= 3:
                ...
                if self.game.current_screen == "puz_pack" or self.game.current_screen == "country" or self.game.current_screen == "linear_progression" or self.game.current_screen == "":
